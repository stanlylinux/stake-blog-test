export const Footer = () => {
  return (
    <div className="bg-dark-blue-300 w-full flex flex-col gap-5 px-4 md:px-10 lg:px-[12em] pt-6 pb-24 lg:py-16 box-border items-center justify-center text-[0.75rem] text-lightsteelblue ">
